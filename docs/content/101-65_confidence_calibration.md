...
StockWise 的核心指标除了买卖信号，还有一个隐形维度：**置信度 (Confidence Level)**。
...
1.  **观察评分分布**：如果连续几天 StockWise 给出的全市场评分都在 0.5 左右波动，说明市场进入了混沌期。
2.  **空仓等待**：没有任何动作，就是最好的动作。
3.  **识别“幻觉”**：如果你发现 AI 的结论与冷冰冰的 K 线完全相反，且置信度极低，请信任 K 线或者空仓。
