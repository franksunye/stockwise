...
flowchart TD
    ...
    LLM[Layer-2: AI 战术参谋长<br/>DeepSeek / Hunyuan]
    
    STATE -->|强指令注入 Trigger| LLM
```

---

## 4. 关键组件规约 (Component Specification)
...
## 6. 技术栈生态与“不造轮子”原则 (Best Practices)
