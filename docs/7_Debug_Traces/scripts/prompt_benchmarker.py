...
# Gemini Config
# Note: Ensure local Gemini proxy is running on 8045
...
async def test_comparison():
    ...
    scenarios = [
        {
            "id": "0_OLD_BASELINE",
            "sys": f"{prompt_dir}/Baseline_Old_System.md",
            "usr": f"{prompt_dir}/Baseline_Old_User.md"
        },
        {
            "id": "B1_MINIMAL_FEATURES",
            "sys": f"{prompt_dir}/Shared_Optimized_System.md",
            "usr": f"{prompt_dir}/B1_Minimal_User.md"
        },
        {
            "id": "B2_RICH_TABLES",
            "sys": f"{prompt_dir}/Shared_Optimized_System.md",
        ...
        {
            "id": "B3_LOGIC_DISTILLED",
            "sys": f"{prompt_dir}/B3_Adversarial_System.md",
            "usr": f"{prompt_dir}/B3_Distilled_User.md"
        }
    ]
    ...
    out_file = f"{base_dir}/results/Four_Way_Benchmark_Results.json"
