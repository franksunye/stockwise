...
2.  **强制风控**：利用 ZISO 的 **“风险阈值”** 功能。不要试图用你的逻辑去解释亏损，只看数字。
3.  **极简化决策**：与其看 100 个指标，不如只看 ZISO 提炼出的 **“量价脉络”**。
...
- 专业背景与交易胜率没有线性对应关系。
- 交易失败常见原因是“执行偏差”，不是“知识不足”。
- 降低主观解释空间通常比增加分析维度更有效。

## 证据口径

- 行为口径：是否严格执行预设止损与仓位规则。
- 决策口径：是否基于固定清单完成入场前检查。
