...
普通用户第一次接触 `ATR Stop`，很容易觉得它只是“更复杂的止损算法”。

但真正让很多交易者佩服它的，不是复杂，而是诚实。
...
这也是为什么很多人会佩服这条规则。因为它不是追求好看，而是在追求更真实。
...
如果要用一句话概括 `ATR Stop`，那不是“高级止损法”。

更准确地说：

**它是在提醒你，真正重要的，不是把止损做得更复杂，而是让风险终于开始按波动说话。**
