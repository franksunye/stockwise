...
- [101-18_echo_chamber.md](/Users/yesun/Code/stockwise/docs/4_Growth_Ops/content/101_academy/101-18_echo_chamber.md)
...
- 节奏：`Hub`
- 战役角色：`破圈钩子`
- 发布目标：让普通投资者先认出自己的动作，再接受“信息不一定在帮你，很多时候是在安慰你”这个反直觉判断

## 一、标题候选

推荐顺序：

1. 买完股票后越刷越踏实，很多时候不是逻辑更强了，而是你更不想认错
2. 很多人不是被行情套住的，而是被自己不停刷出来的利好套住的
3. 你以为自己在做研究，很多时候其实只是在给亏损找安慰
4. 你以为自己在刷信息，很多时候只是在反复听自己想听的话

建议：

- 公众号首发优先用 `1`
- 如果想更狠、更像公域传播标题，可改用 `2`
- 如果想保留更强认知判断感，可改用 `3`
- `4` 适合做次选 AB 标题
...
1. 很多人一买完股票，就会突然变得特别爱学习。
2. 公告要看，快讯要刷，股吧要翻，短视频要找，连评论区里一句“这票逻辑还在”都舍不得漏掉。
3. 但讲真，很多时候你不是在研究，你只是在给自己的持仓找安慰。
...
1. 封面图
2. 开头两屏纯文字
3. 在“你看到的信息越多”前后插入 `body_1`
4. 在“ZISO 为什么几乎不把新闻解读当成核心武器”前后插入 `body_2`
5. 结尾保持纯文字，不再加图
...
- 不出现人物，不出现脸
- 一部手机放在桌面中央
- 同一只股票的重复利好内容围成“安慰型回音墙”
- 一眼能看出这不是在获得新判断，而是在被重复信息安抚
...
- 买完股票后拼命刷新闻、刷股吧、刷短视频的人，应该都会被这篇扎一下。很多时候你不是研究越做越深，而是套住以后，越来越会给自己找安慰。
...
1. 标题是否保留“熟悉动作 + 反转判断”结构
2. 第一屏是否直接出现“买完就刷信息”
3. `h2` 在手机预览里是否显得克制
4. 封面是否一眼能看懂，不像抽象概念海报
5. 正文图片是否不超过 `2` 张
6. 是否存在过多加粗或高亮
7. 结尾是否保持干净，不叠加关注组件和复杂样式
