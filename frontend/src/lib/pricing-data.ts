...
export function getPricingPlans(locale: string): PricingPlan[] {
    ...
    return [
        ...
        },
        {
            ...
            priceId: isCN ? STRIPE_PRICE_IDS.CN_GO_MONTHLY : STRIPE_PRICE_IDS.USD_GO_MONTHLY,
            priceIdAnnual: isCN ? STRIPE_PRICE_IDS.CN_GO_YEARLY : STRIPE_PRICE_IDS.USD_GO_YEARLY,
            highlight: true,
            icon: Crown,
            color: 'indigo',
        },
