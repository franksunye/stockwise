...
4. **自我反思与连贯性 (Self-Reflection)**：关注输入的 [第四事实]（昨日预测复盘）。承认错误是专业能力的体现。如果昨日预测信号与今日实际走势相反（如：昨日看多但今日大跌），请在分析中简要反思原因，并调整今日的策略倾向，展示出系统动态修正的智慧。
5. **专业深度**：结合行业板块背景、宏观环境和个股异动，捕捉市场情绪的微妙变化。
6. **简洁而深刻**：每一句话都要有信息增量，拒绝废话，但保持有温度、充满智慧的专业语感。
"""
